            ...
            <form action="{{ route('store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        ...
                        <input name="judul" id="judul" placeholder="judul" value="{{ old('judul') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="">
                    </div>
                    ...
                    <div>
                        ...
                        <select id="category" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <option value="web-programming" {{ old('category') == 'web-programming' ? 'selected' : 'none' }}>Web Programming</option>
                            <option value="ui/ux" {{ old('category') == 'ui/ux' ? 'selected' : 'none' }}>UI/UX</option>
                            <option value="mobile-developer" {{ old('category') == 'mobile-developer' ? 'selected' : 'none' }}>Mobile Development</option>
                        </select>
                    </div>
                    <div>
                        <label for="link" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Type your link Project</label>
